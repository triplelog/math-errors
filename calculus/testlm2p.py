...
dvipng -bg $BACKGROUND -o $FNAME -q -T 7in,9in -D 118 -z 3 $TMPDIR/$BNAME.dvi > /dev/null
rm $TMPDIR/$BNAME.aux $TMPDIR/$BNAME.dvi $TMPDIR/$BNAME.log $TMPDIR/$BNAME.tex > /dev/null