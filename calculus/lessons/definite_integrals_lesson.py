...
def definite_integrals_lesson(request):
    ...
    vLinks = [{'href':'definite_integrals_worksheet.hmtl','title':'Definite Integrals Worksheet','description':"Work as many problems as you need. They're broken into many categories for your pleasure."}]
