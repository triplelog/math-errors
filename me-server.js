...
app.get('/addition',
	function(req, res){
		var types = [{name:'Addition',goals:[{name:'Error Free',progress:0},{name:'Carry Error',progress:0},{name:'Carry 0 of 2',progress:0},{name:'Carry 1 of 2',progress:0},{name:'Match Error',progress:0}]}];
